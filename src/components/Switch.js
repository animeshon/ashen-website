...
const Switch = () => {
    ...
    return (
        ...
        >
            ...
            <div className={"confidence"}><p>Confidence: <span className={`confidence-${confidence}`}>{confidence}</span> | Query time: { `${responseTime}s` }</p></div>
            <div className={"wrap"}>
